...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        respaldo = {producto.id: float(producto.precio_unitario) for producto in Producto.objects.all()}
        respaldo_file = "respaldo_precios.json"
        with open(respaldo_file, "w", encoding="utf-8") as f:
        ...
        self.stdout.write(self.style.SUCCESS(f"Se aumentaron todos los precios en un {porcentaje_aumento}%"))
